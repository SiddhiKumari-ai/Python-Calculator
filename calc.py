...
window.title("MY OWN CALCULATOR")

inputVar = tk.StringVar()

f1 = ttk.Frame(master=window)
f2 = ttk.Frame(master=window)
f3 = ttk.Frame(master=window)
f4 = ttk.Frame(master=window)
f5 = ttk.Frame(master=window)

display = ttk.Entry(master=f1,font="calibri 25",justify="right",textvariable=inputVar,state="disabled")
...
display.pack(pady=10,padx=20,expand=True,fill="both")
f1.pack(expand=True,fill="both")
l1 = ttk.Label(text="Mannual Calculator",font="calibri 25")
l1.pack(pady=10)
